...
enum pv_Result_t {
  ...
  pv_RESULT_NOT_IMPLEMENTED = -4,
  pv_RESULT_NOT_SUPPORTED = -3,
  pv_RESULT_MODULE_LOAD_ERROR = -2,
...
struct pv_Module_t;
typedef struct pv_Module_t* pv_Module;

struct pv_ModuleParams_t
{
  char* name;
...
typedef struct pv_ModuleParams_t pv_ModuleParams;

typedef pv_Result (*pv_AcquireModuleFunc)(pv_ModuleParams params, pv_Module* pvmodule);
#define pv_AcquireModuleFuncName "AcquireModule"
pv_EXPORT pv_Result pvAcquireModule(pv_ModuleParams params, pv_Module* pvmodule);

typedef pv_Result (*pv_ReleaseModuleFunc)(pv_Module pvmodule);
#define pv_ReleaseModuleFuncName "ReleaseModule"
pv_EXPORT pv_Result pvReleaseModule(pv_Module pvmodule);

typedef pv_Result (*pv_InitModuleFunc)();
#define pv_InitModuleFuncName "InitModule"

typedef pv_Result (*pv_shutdownModuleFunc)();
#define pv_shutdownModuleFuncName "ShutdownModule"
...
typedef pv_Result (*pv_CreatePortalFunc)(pv_Module pvmodule, pv_PortalParams params, pv_Portal* portal);
#define pv_CreatePortalFuncName "CreatePortal"
pv_EXPORT pv_Result pvCreatePortal(pv_Module pvmodule, pv_PortalParams params, pv_Portal* portal);
...
typedef pv_Result (*pv_GetPortalPropertyFunc)(pv_Portal portal, char* propertyName, size_t propertyNameSizeBytes, pv_Context* properties);
#define pv_GetPortalPropertyFuncName "GetPortalProperty"
pv_EXPORT pv_Result pvGetPortalProperty(pv_Portal portal, char* propertyName, size_t propertyNameSizeBytes, pv_Context* properties);
